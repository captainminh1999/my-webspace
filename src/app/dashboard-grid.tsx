      ...
      <div className="mx-auto max-w-[1200px]">
        ...
        >
          {widgets.map((w) => (
            <motion.div
              key={w.id}
              className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700 flex flex-col transition-transform duration-300 ease-out hover:shadow-xl hover:scale-[1.01]"
            >
              {/* drag handle */}
