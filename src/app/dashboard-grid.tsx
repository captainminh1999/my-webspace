      ...
      <div className="mx-auto max-w-[1200px]">
        ...
        >
          {widgets.map((w) => (
            <motion.div
              key={w.id}
              className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700 flex flex-col transition-transform duration-200 ease-out hover:shadow-xl hover:-translate-y-1"
            >
              {/* drag handle */}
