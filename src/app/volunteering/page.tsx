...
// Import shared types
import type { VolunteeringEntry } from '@/types'; // Assuming @/ is configured for src/

// Import shared helper functions
import { formatTextWithLineBreaks, getDisplayCause } from '@/utils/formatters'; // Assuming @/ is configured for src/
...
export const metadata: Metadata = {
  title: `All Volunteering Activities - My Space`,
