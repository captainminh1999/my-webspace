        ...
        {experienceData && experienceData.length > 0 && (
          <Section title="Experience">
            ...
            {experienceData.length > MAX_ITEMS_MAIN_PAGE && (
              <ShowAllButton count={experienceData.length} sectionName="Experiences" sectionPath="/experience" />
            )}
          </Section>
        )}
        ...
        {educationData && educationData.length > 0 && (
          <Section title="Education">
            ...
            {educationData.length > MAX_ITEMS_MAIN_PAGE && (
              <ShowAllButton count={educationData.length} sectionName="Education Entries" sectionPath="/education" />
            )}
          </Section>
        )}
        ...
        {licensesData && licensesData.length > 0 && (
          <Section title="Licenses & Certifications">
            ...
            {licensesData.length > MAX_ITEMS_MAIN_PAGE && (
              <ShowAllButton count={licensesData.length} sectionName="Licenses & Certifications" sectionPath="/licenses" />
            )}
          </Section>
        )}
        ...
        {projectsData && projectsData.length > 0 && (
          <Section title="Projects">
            ...
            {projectsData.length > MAX_ITEMS_MAIN_PAGE && (
              <ShowAllButton count={projectsData.length} sectionName="Projects" sectionPath="/projects" />
            )}
          </Section>
        )}
        ...
        {volunteeringData && volunteeringData.length > 0 && (
          <Section title="Volunteering">
            ...
            {volunteeringData.length > MAX_ITEMS_MAIN_PAGE && (
              <ShowAllButton count={volunteeringData.length} sectionName="Volunteering Activities" sectionPath="/volunteering" />
            )}
          </Section>
        )}
        ...
        {recommendationsReceivedData && recommendationsReceivedData.length > 0 && (
          <Section title="Recommendations Received">
            ...
            {recommendationsReceivedData.length > MAX_ITEMS_MAIN_PAGE && (
              <ShowAllButton count={recommendationsReceivedData.length} sectionName="Recommendations" sectionPath="/recommendations" />
            )}
          </Section>
        )}
        ...
        {honorsAwardsData && honorsAwardsData.length > 0 && (
          <Section title="Honors & Awards">
            ...
            {honorsAwardsData.length > MAX_ITEMS_MAIN_PAGE && (
              <ShowAllButton count={honorsAwardsData.length} sectionName="Honors & Awards" sectionPath="/honors-awards" />
            )}
          </Section>
        )}
        ...
        {languagesData && languagesData.length > 0 && (
          <Section title="Languages">
            ...
            {languagesData.length > MAX_ITEMS_MAIN_PAGE && (
              <ShowAllButton count={languagesData.length} sectionName="Languages" sectionPath="/languages" />
            )}
          </Section>
        )}
